...
let allTrackers = new Map();
let tableTrackers = [];
let allDomainsForParentCompanyView = new Set();
let onlyParentCompanyTrackers = new Map();

function logTracker(requestDetails) {
    if (requestDetails.originUrl != null && requestDetails.url != null) {
        let tracker = new URL(requestDetails.url).hostname;
